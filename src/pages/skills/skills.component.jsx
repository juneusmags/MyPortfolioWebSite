...
const Skills = () => {
  return (
    <div className="pt-3 pb-3" id="skills">
      <h1 className="text-center font-details-b pb-4"> <strong>Technical Skills</strong> </h1>
      <CardDeck>
                ...
                <Card.Text className="card-text d-flex justify-content-start flex-column">
                  {skills.frontend.map((skill, index) => (
                    <span className="p-2" key={index}>
                      <a className="text-dark " href={skill.link} target="_blank" rel="noopener noreferrer">
          ...
          <Col md={4}>
            ...
            <Card className="focus mt-2 mb-2">
              <Card.Body>
                ...
                <Card.Text className="card-text d-flex justify-content-start flex-column">
                  <span className="p-2">
                    <a className="text-dark " href={skills.versionControl[0].link} target="_blank" rel="noopener noreferrer">
